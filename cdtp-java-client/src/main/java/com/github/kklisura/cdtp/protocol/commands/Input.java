...
public interface Input {
	 ...
	 */
	void dispatchMouseEvent(@ParamName("type") Type type, @ParamName("x") Double x, @ParamName("y") Double y);
	 ...
	 */
	@Experimental
	void dispatchTouchEvent(@ParamName("type") Type type, @ParamName("touchPoints") List<TouchPoint> touchPoints);
	 ...
	 */
	@Experimental
	void emulateTouchFromMouseEvent(@ParamName("type") Type type, @ParamName("x") Integer x, @ParamName("y") Integer y, @ParamName("timestamp") Double timestamp, @ParamName("button") Button button);
	 ...
	 */
	@Experimental
	void synthesizePinchGesture(@ParamName("x") Double x, @ParamName("y") Double y, @ParamName("scaleFactor") Double scaleFactor);
