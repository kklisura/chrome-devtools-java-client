...
public class Node {
	...
	@Optional
	private List<com.github.kklisura.cdtp.protocol.types.dom.Node> children;
	...
	@Optional
	private com.github.kklisura.cdtp.protocol.types.dom.Node contentDocument;
	...
	@Experimental
	@Optional
	private com.github.kklisura.cdtp.protocol.types.dom.Node templateContent;
	...
	@Optional
	private com.github.kklisura.cdtp.protocol.types.dom.Node importedDocument;
	 ...
	 * Pseudo elements associated with this node.
	 */
	public void setPseudoElements(List<com.github.kklisura.cdtp.protocol.types.dom.Node> pseudoElements) {
	 ...
	 * Import document for the HTMLImport links.
	 */
	public void setImportedDocument(com.github.kklisura.cdtp.protocol.types.dom.Node importedDocument) {
