...
public class TypesBuilder {
  ...
  static {
    registerTypeArrayItem(
        com.github.kklisura.cdtp.definition.builder.protocol.types.type.array.items.StringArrayItem
            .class,
        "String");
    registerTypeArrayItem(
        com.github.kklisura.cdtp.definition.builder.protocol.types.type.array.items.NumberArrayItem
            .class,
        "Double");
    registerTypeArrayItem(
        com.github.kklisura.cdtp.definition.builder.protocol.types.type.array.items.IntegerArrayItem
            .class,
        "Integer");
  }
    ...
    if (CollectionUtils.isNotEmpty(enumValues)) {
      for (String enumValue : enumValues) {
        enumBuilder.addEnumConstant(
            com.github.kklisura.cdtp.definition.builder.support.utils.StringUtils.toEnumConstant(
                enumValue),
            enumValue);
      }
    }
  ...
  protected static String getArrayItemJavaType(
      com.github.kklisura.cdtp.definition.builder.protocol.types.type.array.ArrayItem arrayItem) {
   ...
   */
  private static <
          T extends com.github.kklisura.cdtp.definition.builder.protocol.types.type.array.ArrayItem>
